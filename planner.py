...
class planner:
    ...
    def initTrajectoryPlanner(self):
        ...
        self.m_utilites=mapManipulator(laser_sig=0.01) # may require tuning
    ...
    def trajectory_planner(self, startPoseCart, endPoseCart):
        ...
        heuristics_mode = "manhattan" # "manhattan" or "euclidean"
        path = search(self.costMap, startPose, endPose, heuristics_mode)
        path_coords = list(map(self.m_utilites.cell_2_position, path))
